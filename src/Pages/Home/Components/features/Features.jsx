...
const Features = () => (
  <div className="ak__features section__padding" id="features">
    <div className="ak__features-heading">
      <h1 className="gradient__text">We have a Dynamic and Innovative Architect and Interior Designer Experts who strive to provide fast and reliable services at unbeatable prices.</h1>
    </div>
